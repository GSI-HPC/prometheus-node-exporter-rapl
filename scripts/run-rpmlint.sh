...
# line-comment):
# - spelling-error: rpmlint's dictionary trips over domain terms (powercap,
#   udev, systemd, sysfs, energy_uj, ...).
...
# - only-non-binary-in-usr-lib: the package is configuration for systemd
